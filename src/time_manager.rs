...
pub trait TimeManager<T: SearchExecutor<ReportData = Vec<Variation>>>: SetOption {
    ...
    ///   search progress report. `update` will be called exactly once
    ///   for each progress report generated by the search, conforming
    ///   to the order in which the reports have been generated.
