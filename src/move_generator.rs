...
pub trait MoveGenerator: Clone + SetOption + Send + 'static {
    ...
    fn from_board(Board) -> Result<Self, IllegalBoard>;
    ...
    /// Returns a bitboard with all pieces that attack a given square.
    fn attacks_to(&self, Square) -> Bitboard;
