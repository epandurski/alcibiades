...
impl Board {
    ...
    // is updated and "true" is returned. If the move is illegal,
    // "false" is returned without updating the board.
    //
    // The move passed to this method should have been generated by
    // Board::generate_moves() for the current position on the board.
