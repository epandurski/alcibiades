...
#[derive(Clone)]
pub struct StandardGenerator<T: BoardEvaluator> {
...
impl<T: BoardEvaluator> MoveGenerator for StandardGenerator<T> {
    type BoardEvaluator = T;

    fn from_board(board: Board) -> Option<StandardGenerator<T>> {
...
impl<T: BoardEvaluator> SetOption for StandardGenerator<T> {
...
impl<T: BoardEvaluator> StandardGenerator<T> {
