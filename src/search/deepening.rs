...
pub struct Deepening<T, S: SearchExecutor<T>> {
    params: SearchParams,
...
impl<T, S: SearchExecutor<T>> Deepening<T, S> {
...
impl<T, S: SearchExecutor<T>> SetOption for Deepening<T, S> {
...
impl<T, S: SearchExecutor<T>> SearchExecutor<T> for Deepening<T, S> {
...
pub struct Aspiration<T, S: SearchExecutor<T>> {
    tt: Arc<T>,
    params: SearchParams,
    search_is_terminated: bool,
    previously_searched_nodes: u64,
...
impl<T, S: SearchExecutor<T>> Aspiration<T, S> {
...
impl<T, S: SearchExecutor<T>> SetOption for Aspiration<T, S> {
    fn options() -> Vec<(String, OptionDescription)> {
        S::options()
    }
...
impl<T, S: SearchExecutor<T>> SearchExecutor<T> for Aspiration<T, S> {
...
pub struct Multipv<T, S: SearchExecutor<T>> {
    tt: Arc<T>,
    params: SearchParams,
    search_is_terminated: bool,
    previously_searched_nodes: u64,
...
impl<T, S: SearchExecutor<T>> Multipv<T, S> {
...
impl<T, S: SearchExecutor<T>> SetOption for Multipv<T, S> {
    fn options() -> Vec<(String, OptionDescription)> {
...
impl<T, S: SearchExecutor<T>> SearchExecutor<T> for Multipv<T, S> {
